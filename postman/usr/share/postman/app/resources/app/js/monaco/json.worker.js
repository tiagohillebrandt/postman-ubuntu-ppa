...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return SymbolKind; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return SelectionRange; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__impl_format_js__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__impl_edit_js__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__impl_scanner_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__impl_parser_js__ = __webpack_require__(22);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_objects_js__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__fillers_vscode_nls_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__deps_vscode_languageserver_types_main_js__ = __webpack_require__(0);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
    ...
    JSONDocument.prototype.validate = function (textDocument, schema) {
        if (this.root && schema) {
            ...
            return validationResult.problems.map(function (p) {
                var range = __WEBPACK_IMPORTED_MODULE_4__deps_vscode_languageserver_types_main_js__["j" /* Range */].create(textDocument.positionAt(p.location.offset), textDocument.positionAt(p.location.offset + p.location.length));
                return __WEBPACK_IMPORTED_MODULE_4__deps_vscode_languageserver_types_main_js__["c" /* Diagnostic */].create(range, p.message, p.severity, p.code);
            });
        }
        return null;
    };
        ...
        if (Array.isArray(schema.type)) {
            if (!schema.type.some(matchesType)) {
                validationResult.problems.push({
                    ...
                    severity: __WEBPACK_IMPORTED_MODULE_4__deps_vscode_languageserver_types_main_js__["d" /* DiagnosticSeverity */].Warning,
...
function parse(textDocument, config) {
            ...
            switch (token_1) {
                ...
                case 13 /* BlockCommentTrivia */:
                    if (Array.isArray(commentRanges)) {
                        commentRanges.push(__WEBPACK_IMPORTED_MODULE_4__deps_vscode_languageserver_types_main_js__["j" /* Range */].create(textDocument.positionAt(scanner.getTokenOffset()), textDocument.positionAt(scanner.getTokenOffset() + scanner.getTokenLength())));
                    }
                    break;
                case 15 /* Trivia */:
    ...
    function _errorAtRange(message, code, startOffset, endOffset, severity) {
        if (severity === void 0) {severity = __WEBPACK_IMPORTED_MODULE_4__deps_vscode_languageserver_types_main_js__["d" /* DiagnosticSeverity */].Error;}
        if (problems.length === 0 || startOffset !== lastProblemOffset) {
            var range = __WEBPACK_IMPORTED_MODULE_4__deps_vscode_languageserver_types_main_js__["j" /* Range */].create(textDocument.positionAt(startOffset), textDocument.positionAt(endOffset));
            problems.push(__WEBPACK_IMPORTED_MODULE_4__deps_vscode_languageserver_types_main_js__["c" /* Diagnostic */].create(range, message, severity, code, textDocument.languageId));
    ...
    function _parseProperty(parent, keysSeen) {
        ...
        if (seen) {
            _errorAtRange(localize('DuplicateKeyWarning', "Duplicate object key"), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].DuplicateKey, node.keyNode.offset, node.keyNode.offset + node.keyNode.length, __WEBPACK_IMPORTED_MODULE_4__deps_vscode_languageserver_types_main_js__["d" /* DiagnosticSeverity */].Warning);
            if (typeof seen === 'object') {
                _errorAtRange(localize('DuplicateKeyWarning', "Duplicate object key"), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].DuplicateKey, seen.keyNode.offset, seen.keyNode.offset + seen.keyNode.length, __WEBPACK_IMPORTED_MODULE_4__deps_vscode_languageserver_types_main_js__["d" /* DiagnosticSeverity */].Warning);
            }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__deps_vscode_languageserver_types_main_js__ = __webpack_require__(0);
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_0__deps_vscode_languageserver_types_main_js__["e"]; });
/* unused harmony reexport SelectionRange */
...
(function (ClientCapabilities) {
    ClientCapabilities.LATEST = {
        textDocument: {
            completion: {
                completionItem: {
                    documentationFormat: [__WEBPACK_IMPORTED_MODULE_0__deps_vscode_languageserver_types_main_js__["h" /* MarkupKind */].Markdown, __WEBPACK_IMPORTED_MODULE_0__deps_vscode_languageserver_types_main_js__["h" /* MarkupKind */].PlainText] } } } };
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(9), __webpack_require__(5)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__diffChange_js__ = __webpack_require__(29);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__functional_js__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lifecycle_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__linkedList_js__ = __webpack_require__(44);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__jsonc_parser_main_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vscode_uri_index_js__ = __webpack_require__(56);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__fillers_vscode_nls_js__ = __webpack_require__(4);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var JSONSchemaService = /** @class */function () {
    ...
    JSONSchemaService.prototype.getRegisteredSchemaIds = function (filter) {
        return Object.keys(this.registeredSchemasIds).filter(function (id) {
            var scheme = __WEBPACK_IMPORTED_MODULE_1__vscode_uri_index_js__["a" /* URI */].parse(id).scheme;
    ...
    JSONSchemaService.prototype.normalizeId = function (id) {
        ...
        try {
            return __WEBPACK_IMPORTED_MODULE_1__vscode_uri_index_js__["a" /* URI */].parse(id).toString();
        }
        catch (e) {
            return id;
        }
...
function toDisplayString(url) {
    try {
        var uri = __WEBPACK_IMPORTED_MODULE_1__vscode_uri_index_js__["a" /* URI */].parse(url);
        if (uri.scheme === 'file') {
            return uri.fsPath;
        }
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__editor_editor_worker_js__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__jsonWorker_js__ = __webpack_require__(49);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_common_worker_simpleWorker_js__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_services_editorSimpleWorker_js__ = __webpack_require__(27);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__errors_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lifecycle_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__platform_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__types_js__ = __webpack_require__(16);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* unused harmony export create */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_common_arrays_js__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__base_common_diff_diff_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__base_common_iterator_js__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__diff_diffComputer_js__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__model_mirrorTextModel_js__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__model_wordHelper_js__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__modes_linkComputer_js__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__modes_supports_inplaceReplaceSupport_js__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__standalone_standaloneBase_js__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__base_common_types_js__ = __webpack_require__(16);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__base_common_strings_js__ = __webpack_require__(31);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__viewModel_prefixSumComputer_js__ = __webpack_require__(33);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_characterClassifier_js__ = __webpack_require__(36);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__promise_polyfill_polyfill_js__ = __webpack_require__(39);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__base_common_cancellation_js__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__base_common_event_js__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__base_common_keyCodes_js__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__base_common_uri_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__core_position_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__core_range_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__core_selection_js__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__core_token_js__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__standaloneEnums_js__ = __webpack_require__(48);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(40).setImmediate, __webpack_require__(5)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__event_js__ = __webpack_require__(20);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__iterator_js__ = __webpack_require__(18);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* unused harmony export create */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__deps_vscode_json_languageservice_jsonLanguageService_js__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__deps_vscode_languageserver_types_main_js__ = __webpack_require__(62);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
    ...
    JSONWorker.prototype._getTextDocument = function (uri) {
        ...
        for (var _i = 0, models_1 = models; _i < models_1.length; _i++) {
            ...
            if (model.uri.toString() === uri) {
                return __WEBPACK_IMPORTED_MODULE_1__deps_vscode_languageserver_types_main_js__["a" /* TextDocument */].create(uri, this._languageId, model.version, model.getValue());
            }
        }
        return null;
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__deps_vscode_languageserver_types_main_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_jsonCompletion_js__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_jsonHover_js__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_jsonValidation_js__ = __webpack_require__(55);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__services_jsonSchemaService_js__ = __webpack_require__(23);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__jsonLanguageTypes_js__ = __webpack_require__(6);
    ...
    return {
        ...
        format: function (d, r, o) {
            ...
            return Object(__WEBPACK_IMPORTED_MODULE_10__jsonc_parser_main_js__["c" /* format */])(d.getText(), range, options).map(function (e) {
                return __WEBPACK_IMPORTED_MODULE_0__deps_vscode_languageserver_types_main_js__["m" /* TextEdit */].replace(__WEBPACK_IMPORTED_MODULE_0__deps_vscode_languageserver_types_main_js__["j" /* Range */].create(d.positionAt(e.offset), d.positionAt(e.offset + e.length)), e.content);
            });
        } };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_json_js__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_strings_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_objects_js__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__deps_vscode_languageserver_types_main_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__fillers_vscode_nls_js__ = __webpack_require__(4);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var JSONCompletion = /** @class */function () {
    ...
    JSONCompletion.prototype.doComplete = function (document, position, doc) {
        ...
        if (node && (node.type === 'string' || node.type === 'number' || node.type === 'boolean' || node.type === 'null')) {
            overwriteRange = __WEBPACK_IMPORTED_MODULE_5__deps_vscode_languageserver_types_main_js__["j" /* Range */].create(document.positionAt(node.offset), document.positionAt(node.offset + node.length));
        } else
        {
            ...
            overwriteRange = __WEBPACK_IMPORTED_MODULE_5__deps_vscode_languageserver_types_main_js__["j" /* Range */].create(document.positionAt(overwriteStart), position);
        }
        var proposed = {};
        var collector = {
            add: function (suggestion) {
                ...
                if (!existing) {
                    ...
                    if (overwriteRange) {
                        suggestion.textEdit = __WEBPACK_IMPORTED_MODULE_5__deps_vscode_languageserver_types_main_js__["m" /* TextEdit */].replace(overwriteRange, suggestion.insertText);
                    }
            ...
            if (node && node.type === 'object') {
                ...
                properties.forEach(function (p) {
                    if (!currentProperty || currentProperty !== p) {
                        proposed[p.keyNode.value] = __WEBPACK_IMPORTED_MODULE_5__deps_vscode_languageserver_types_main_js__["a" /* CompletionItem */].create('__');
                    }
                });
                ...
                if (!schema && currentWord.length > 0 && document.getText().charAt(offset - currentWord.length - 1) !== '"') {
                    collector.add({
                        kind: __WEBPACK_IMPORTED_MODULE_5__deps_vscode_languageserver_types_main_js__["b" /* CompletionItemKind */].Property,
                        label: _this.getLabelForValue(currentWord),
                        insertText: _this.getInsertTextForProperty(currentWord, null, false, separatorAfter_1),
                        insertTextFormat: __WEBPACK_IMPORTED_MODULE_5__deps_vscode_languageserver_types_main_js__["f" /* InsertTextFormat */].Snippet, documentation: '' });
                    ...
                    Object.keys(schemaProperties_1).forEach(function (key) {
                        ...
                        if (typeof propertySchema === 'object' && !propertySchema.deprecationMessage && !propertySchema.doNotSuggest) {
                            var proposal = {
                                ...
                                insertTextFormat: __WEBPACK_IMPORTED_MODULE_5__deps_vscode_languageserver_types_main_js__["f" /* InsertTextFormat */].Snippet,
    ...
    JSONCompletion.prototype.addDollarSchemaCompletions = function (separatorAfter, collector) {
        ...
        schemaIds.forEach(function (schemaId) {return collector.add({
                kind: __WEBPACK_IMPORTED_MODULE_5__deps_vscode_languageserver_types_main_js__["b" /* CompletionItemKind */].Module,
    ...
    JSONCompletion.prototype.getSuggestionKind = function (type) {
        ...
        if (!type) {
            return __WEBPACK_IMPORTED_MODULE_5__deps_vscode_languageserver_types_main_js__["b" /* CompletionItemKind */].Value;
        }
        switch (type) {
            case 'string':return __WEBPACK_IMPORTED_MODULE_5__deps_vscode_languageserver_types_main_js__["b" /* CompletionItemKind */].Value;
            case 'object':return __WEBPACK_IMPORTED_MODULE_5__deps_vscode_languageserver_types_main_js__["b" /* CompletionItemKind */].Module;
            case 'property':return __WEBPACK_IMPORTED_MODULE_5__deps_vscode_languageserver_types_main_js__["b" /* CompletionItemKind */].Property;
            default:return __WEBPACK_IMPORTED_MODULE_5__deps_vscode_languageserver_types_main_js__["b" /* CompletionItemKind */].Value;}
    ...
    JSONCompletion.prototype.fromMarkup = function (markupString) {
        if (markupString && this.doesSupportMarkdown()) {
            return {
                kind: __WEBPACK_IMPORTED_MODULE_5__deps_vscode_languageserver_types_main_js__["h" /* MarkupKind */].Markdown,
                value: markupString };
    ...
    JSONCompletion.prototype.doesSupportMarkdown = function () {
        if (!Object(__WEBPACK_IMPORTED_MODULE_4__utils_objects_js__["c" /* isDefined */])(this.supportsMarkdown)) {
            ...
            this.supportsMarkdown = completion && completion.completionItem && Array.isArray(completion.completionItem.documentationFormat) && completion.completionItem.documentationFormat.indexOf(__WEBPACK_IMPORTED_MODULE_5__deps_vscode_languageserver_types_main_js__["h" /* MarkupKind */].Markdown) !== -1;
        }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__format_js__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__parser_js__ = __webpack_require__(22);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var JSONHover = /** @class */function () {
    ...
    JSONHover.prototype.doHover = function (document, position, doc) {
        ...
        var hoverRange = __WEBPACK_IMPORTED_MODULE_1__deps_vscode_languageserver_types_main_js__["j" /* Range */].create(document.positionAt(hoverRangeNode.offset), document.positionAt(hoverRangeNode.offset + hoverRangeNode.length));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__jsonSchemaService_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__deps_vscode_languageserver_types_main_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__fillers_vscode_nls_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_objects_js__ = __webpack_require__(13);
...
var JSONValidation = /** @class */function () {
    ...
    JSONValidation.prototype.configure = function (raw) {
        if (raw) {
            ...
            this.commentSeverity = raw.allowComments ? void 0 : __WEBPACK_IMPORTED_MODULE_1__deps_vscode_languageserver_types_main_js__["d" /* DiagnosticSeverity */].Error;
        }
    };
    JSONValidation.prototype.doValidation = function (textDocument, jsonDocument, documentSettings, schema) {
        ...
        var getDiagnostics = function (schema) {
            var trailingCommaSeverity = documentSettings ? toDiagnosticSeverity(documentSettings.trailingCommas) : __WEBPACK_IMPORTED_MODULE_1__deps_vscode_languageserver_types_main_js__["d" /* DiagnosticSeverity */].Error;
            ...
            if (schema) {
                if (schema.errors.length && jsonDocument.root) {
                    ...
                    if (property && property.keyNode.value === '$schema') {
                        ...
                        var range = __WEBPACK_IMPORTED_MODULE_1__deps_vscode_languageserver_types_main_js__["j" /* Range */].create(textDocument.positionAt(node.offset), textDocument.positionAt(node.offset + node.length));
                        addProblem(__WEBPACK_IMPORTED_MODULE_1__deps_vscode_languageserver_types_main_js__["c" /* Diagnostic */].create(range, schema.errors[0], __WEBPACK_IMPORTED_MODULE_1__deps_vscode_languageserver_types_main_js__["d" /* DiagnosticSeverity */].Warning, __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].SchemaResolveError));
                    } else
                    {
                        var range = __WEBPACK_IMPORTED_MODULE_1__deps_vscode_languageserver_types_main_js__["j" /* Range */].create(textDocument.positionAt(astRoot.offset), textDocument.positionAt(astRoot.offset + 1));
                        addProblem(__WEBPACK_IMPORTED_MODULE_1__deps_vscode_languageserver_types_main_js__["c" /* Diagnostic */].create(range, schema.errors[0], __WEBPACK_IMPORTED_MODULE_1__deps_vscode_languageserver_types_main_js__["d" /* DiagnosticSeverity */].Warning, __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].SchemaResolveError));
                    }
                } else
                {
            ...
            if (typeof commentSeverity === 'number') {
                ...
                jsonDocument.comments.forEach(function (c) {
                    addProblem(__WEBPACK_IMPORTED_MODULE_1__deps_vscode_languageserver_types_main_js__["c" /* Diagnostic */].create(c, message_1, commentSeverity, __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].CommentNotPermitted));
                });
            }
            return diagnostics;
        };
...
function schemaAllowsComments(schemaRef) {
    if (schemaRef && typeof schemaRef === 'object') {
        if (Object(__WEBPACK_IMPORTED_MODULE_4__utils_objects_js__["b" /* isBoolean */])(schemaRef.allowComments)) {
        ...
        if (schemaRef.allOf) {
            for (var _i = 0, _a = schemaRef.allOf; _i < _a.length; _i++) {
                ...
                if (Object(__WEBPACK_IMPORTED_MODULE_4__utils_objects_js__["b" /* isBoolean */])(allow)) {
                    return allow;
                }
            }
        }
...
function schemaAllowsTrailingCommas(schemaRef) {
    if (schemaRef && typeof schemaRef === 'object') {
        if (Object(__WEBPACK_IMPORTED_MODULE_4__utils_objects_js__["b" /* isBoolean */])(schemaRef.allowsTrailingCommas)) {
...
function toDiagnosticSeverity(severityLevel) {
    switch (severityLevel) {
        case 'error':return __WEBPACK_IMPORTED_MODULE_1__deps_vscode_languageserver_types_main_js__["d" /* DiagnosticSeverity */].Error;
        case 'warning':return __WEBPACK_IMPORTED_MODULE_1__deps_vscode_languageserver_types_main_js__["d" /* DiagnosticSeverity */].Warning;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__deps_vscode_languageserver_types_main_js__ = __webpack_require__(0);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var JSONDocumentSymbols = /** @class */function () {
                        ...
                        for (var _i = 0, _a = item.properties; _i < _a.length; _i++) {
                            ...
                            if (property.keyNode.value === 'key') {
                                if (property.valueNode) {
                                    if (property.valueNode) {
                                        var location = __WEBPACK_IMPORTED_MODULE_3__deps_vscode_languageserver_types_main_js__["g" /* Location */].create(document.uri, getRange(document, item));
                                        result_1.push({ name: __WEBPACK_IMPORTED_MODULE_0__parser_jsonParser_js__["d" /* getNodeValue */](property.valueNode), kind: __WEBPACK_IMPORTED_MODULE_3__deps_vscode_languageserver_types_main_js__["l" /* SymbolKind */].Function, location: location });
                                    }
                                    return;
                                }
                            }
        ...
        var collectOutlineEntries = function (result, node, containerName) {
            ...
            if (node.type === 'object') {
                node.properties.forEach(function (property) {
                    var location = __WEBPACK_IMPORTED_MODULE_3__deps_vscode_languageserver_types_main_js__["g" /* Location */].create(document.uri, getRange(document, property));
                        ...
                        for (var _i = 0, _a = item.properties; _i < _a.length; _i++) {
                            ...
                            if (property.keyNode.value === 'key') {
                                if (property.valueNode) {
                                    ...
                                    result_2.push({ name: __WEBPACK_IMPORTED_MODULE_0__parser_jsonParser_js__["d" /* getNodeValue */](property.valueNode), kind: __WEBPACK_IMPORTED_MODULE_3__deps_vscode_languageserver_types_main_js__["l" /* SymbolKind */].Function, range: range, selectionRange: selectionRange });
                                }
                                return;
                            }
                        }
    ...
    JSONDocumentSymbols.prototype.getSymbolKind = function (nodeType) {
        switch (nodeType) {
            case 'object':
                return __WEBPACK_IMPORTED_MODULE_3__deps_vscode_languageserver_types_main_js__["l" /* SymbolKind */].Module;
            case 'string':
                return __WEBPACK_IMPORTED_MODULE_3__deps_vscode_languageserver_types_main_js__["l" /* SymbolKind */].String;
            case 'number':
                return __WEBPACK_IMPORTED_MODULE_3__deps_vscode_languageserver_types_main_js__["l" /* SymbolKind */].Number;
            case 'array':
                return __WEBPACK_IMPORTED_MODULE_3__deps_vscode_languageserver_types_main_js__["l" /* SymbolKind */].Array;
            case 'boolean':
                return __WEBPACK_IMPORTED_MODULE_3__deps_vscode_languageserver_types_main_js__["l" /* SymbolKind */].Boolean;
            default: // 'null'
                return __WEBPACK_IMPORTED_MODULE_3__deps_vscode_languageserver_types_main_js__["l" /* SymbolKind */].Variable;}
    ...
    JSONDocumentSymbols.prototype.getColorPresentations = function (document, doc, color, range) {
        ...
        result.push({ label: label, textEdit: __WEBPACK_IMPORTED_MODULE_3__deps_vscode_languageserver_types_main_js__["m" /* TextEdit */].replace(range, JSON.stringify(label)) });
        return result;
    };
...
function getRange(document, node) {
    return __WEBPACK_IMPORTED_MODULE_3__deps_vscode_languageserver_types_main_js__["j" /* Range */].create(document.positionAt(node.offset), document.positionAt(node.offset + node.length));
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__fillers_vscode_nls_js__ = __webpack_require__(4);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
        ...
        switch (token) {
            ...
            case 13 /* BlockCommentTrivia */:{
                    ...
                    if (scanner.getTokenError() === 1 /* UnexpectedEndOfComment */ && startLine + 1 < document.lineCount) {
                        scanner.setPosition(document.offsetAt(__WEBPACK_IMPORTED_MODULE_0__deps_vscode_languageserver_types_main_js__["i" /* Position */].create(startLine + 1, 0)));
                    } else
                    {
...
function getSelectionRanges(document, positions, doc) {
    function getSelectionRange(position) {
        ...
        for (var index = result.length - 1; index >= 0; index--) {
            current = __WEBPACK_IMPORTED_MODULE_0__deps_vscode_languageserver_types_main_js__["k" /* SelectionRange */].create(result[index], current);
        }
        if (!current) {
            current = __WEBPACK_IMPORTED_MODULE_0__deps_vscode_languageserver_types_main_js__["k" /* SelectionRange */].create(__WEBPACK_IMPORTED_MODULE_0__deps_vscode_languageserver_types_main_js__["j" /* Range */].create(position, position));
        }
        return current;
    }
    function newRange(start, end) {
        return __WEBPACK_IMPORTED_MODULE_0__deps_vscode_languageserver_types_main_js__["j" /* Range */].create(document.positionAt(start), document.positionAt(end));
    }
...
/* unused harmony export ColorInformation */
/* unused harmony export ColorPresentation */
/* unused harmony export FoldingRangeKind */
/* unused harmony export FoldingRange */
/* unused harmony export DiagnosticRelatedInformation */
...
/* unused harmony export MarkupContent */
/* unused harmony export CompletionItemKind */
/* unused harmony export InsertTextFormat */
...
/* unused harmony export DocumentLink */
/* unused harmony export EOL */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TextDocument; });
/* unused harmony export TextDocumentSaveReason */
/* --------------------------------------------------------------------------------------------
 * Copyright (c) Microsoft Corporation. All rights reserved.
 * Licensed under the MIT License. See License.txt in the project root for license information.
