...
class AbstractUpdater extends EventEmitter {
     ...
     */
    onUpdateDownloaded (event, notes, name, date, url, downloadVersion) {
        this.logger.info('@postman/app-updater: Update updateDownloaded', notes, name, date, url, downloadVersion);
        this.emit('updateDownloaded', event, notes, name, date, url, downloadVersion);
    }
